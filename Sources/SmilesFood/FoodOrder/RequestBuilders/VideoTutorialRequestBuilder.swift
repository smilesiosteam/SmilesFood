//
//  VideoTutorialRequestBuilder.swift
//  House
//
...
enum VideoTutorialRequestBuilder {
    
    // organise all the end points here for clarity
    case getVideoTutorial(request: GetVideoTutorialRequestModel)
    ...
    var requestBody: Encodable? {
        switch self {
        case .getVideoTutorial(let request):
            return request
        }
    }
