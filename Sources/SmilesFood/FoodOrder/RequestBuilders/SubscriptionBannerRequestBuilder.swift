//
//  SubscriptionBannerRequestBuilder.swift
//  House
//
...
enum SubscriptionBannerRequestBuilder {
    
    // organise all the end points here for clarity
    case getSubscriptionBanner(request: GetSubscriptionBannerRequestModel)
    ...
    var requestBody: Encodable? {
        switch self {
        case .getSubscriptionBanner(let request):
            return request
        }
    }
